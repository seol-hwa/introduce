...
function header() {
    ...
    menus.forEach((menu, index) => {
      menu.addEventListener("click", function (e) {
        const offsetAbsolute =
          window.pageYOffset + section[index].getBoundingClientRect().top - 160;
        e.preventDefault();
  ...
  function mobileGnb() {
    ...
    mobileMenus.forEach((menu, index) => {
      menu.addEventListener("click", function (e) {
        const offsetAbsolute =
          window.pageYOffset + section[index].getBoundingClientRect().top - 100;
        e.preventDefault();
...
function about() {
  ...
  let aboutBoxAbsoluteBot =
    window.pageYOffset + aboutBox.getBoundingClientRect().top;
  let imgAbsoluteBot =
    aboutBoxAbsoluteBot + aboutBox.clientHeight - img.offsetHeight - 150;
